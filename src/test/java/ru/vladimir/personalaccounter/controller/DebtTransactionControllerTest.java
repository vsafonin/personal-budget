...
class DebtTransactionControllerTest {
	...
	/*
	 * тестирую что авторизованный пользователь может открыть страницу создания DebtTransaction
	...
	/*
	 * ожидаю что если запросить существующий DebtTransaction и пользователь авторизован получу редирект
	...
	/*
	 * тестирую что если авторизованный пользователь пытается сохранить траназкцию владельцем которой он не является
